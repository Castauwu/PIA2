  ...
  <div class="rightbox">
    <div class="profile" >
     <h1 style="left: 30%;position: relative; width:300px;">Trabajos En Equipo.</h1>
      ...
      <button class="redirigir2" onclick="window.location.href='unirse_trabajo.php'">Unirse a un trabajo</button>
      <i class="cosas fa fa-id-card" aria-hidden="true"></i>

      <button class="redirigir2" onclick="window.location.href='trabajos.php'">Evaluar compañeros</button>
