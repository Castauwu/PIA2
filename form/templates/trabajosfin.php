...
<div class="container">
  ...
  <div class="leftbox">
    <nav>
      ...
      <a id="profile" data-tooltip="Trabajos en equipo"class="active"><i class="fa fa-tasks"  ></i></a><br><a id="privacy"onclick="location.href='empleados.php'"><i class="fa fa-address-book"></i></a>
  ...
  <div class="rightbox">
    <div class="profile" >
      <br><br>
      <h1>¡Trabajo Ingresado Con Exito!</h1>
    </div>
  </div>
</div>
